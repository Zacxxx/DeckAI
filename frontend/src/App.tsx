...
export default function App() {
  ...
  const [html, setHtml] = useState('<div style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #fdfbf7 0%, #e8e4d9 100%);"><h1 style="color: #2c2b29; font-size: 82px; letter-spacing: -2px; font-weight: 500;">Deck AI Canvas Ready</h1></div>');
    ...
    <div className="w-screen h-screen flex flex-col bg-[#faf8f5] text-[#2c2b29] font-sans antialiased">
      ...
      <main className="flex-1 relative overflow-hidden flex">
        ...
        <section className="flex-1 relative shadow-[inset_0_0_100px_rgba(0,0,0,0.02)]">
          <Canvas format={format} htmlContent={html} />
        </section>
      </main>
    </div>
  );
